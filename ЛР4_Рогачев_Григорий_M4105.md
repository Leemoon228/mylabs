...
Docker volume `loki-data`. Grafana datasource и dashboard создаются из файлов
provisioning при запуске
...
Логи приложения собираются Grafana Alloy из Docker-контейнера, передаются в Loki и доступны для поиска и анализа в Grafana.
